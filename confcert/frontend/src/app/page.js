    ...
    <div className="min-h-screen bg-linear-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        <div className="text-center mb-16">
          <div className="inline-block mb-6 px-6 py-2 bg-linear-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full">
          ...
          <Link href="/documentation">
            <button className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-linear-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {/* ConfCert Project */}
          <Link href="/confcert">
            <div className="group bg-linear-to-b from-slate-800 to-slate-900 border-2 border-yellow-500/30 hover:border-yellow-400 rounded-2xl p-8 shadow-[0_10px_40px_-5px_rgba(234,179,8,0.3)] hover:shadow-[0_20px_60px_-5px_rgba(234,179,8,0.5)] transition-all duration-300 hover:scale-105 cursor-pointer">
              <div className="w-16 h-16 bg-linear-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300">
          ...
          <Link href="/voting">
            <div className="group bg-linear-to-b from-slate-800 to-slate-900 border-2 border-blue-500/30 hover:border-blue-400 rounded-2xl p-8 shadow-[0_10px_40px_-5px_rgba(59,130,246,0.3)] hover:shadow-[0_20px_60px_-5px_rgba(59,130,246,0.5)] transition-all duration-300 hover:scale-105 cursor-pointer">
              <div className="w-16 h-16 bg-linear-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300">
          ...
          <Link href="/donate">
            <div className="group bg-linear-to-b from-slate-800 to-slate-900 border-2 border-green-500/30 hover:border-green-400 rounded-2xl p-8 shadow-[0_10px_40px_-5px_rgba(34,197,94,0.3)] hover:shadow-[0_20px_60px_-5px_rgba(34,197,94,0.5)] transition-all duration-300 hover:scale-105 cursor-pointer">
              <div className="w-16 h-16 bg-linear-to-br from-green-400 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-300">
          ...
          <Link href="/university-certificate">
            <div className="group bg-linear-to-b from-slate-800 to-slate-900 border-2 border-indigo-500/30 hover:border-indigo-400 rounded-2xl p-8 shadow-[0_10px_40px_-5px_rgba(99,102,241,0.3)] hover:shadow-[0_20px_60px_-5px_rgba(99,102,241,0.5)] transition-all duration-300 hover:scale-105 cursor-pointer">
          ...
          <div className="bg-linear-to-b from-slate-800 to-slate-900 border-2 border-slate-700 rounded-2xl p-8 opacity-50">
            <div className="w-16 h-16 bg-linear-to-br from-slate-600 to-slate-700 rounded-xl flex items-center justify-center mb-6">
